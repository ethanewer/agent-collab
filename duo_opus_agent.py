"""Duo agent: two Claude Code (Opus 4.6) instances collaborating via a shared append-only log file."""
...
class DuoOpusClaudeCode(BaseInstalledAgent):
    @staticmethod
    def name() -> str:
        return "claude-code-duo-opus"
